...
class GeneratePairs:
    ...
    def __init__(self, args):
        ...
        self.pairs_filepath = os.path.join(args.saved_dir)
    ...
    def _generate_mismatches_pairs(self):
        ...
        for i, name in enumerate(os.listdir(self.data_dir)):
            ...
            with open(self.pairs_filepath, "a") as f:
                ...
                # print(name + "\t" + file1.split("_")[1].lstrip("0").rstrip(self.img_ext) +"\t" + other_dir + "\t" + file2.split("_")[1].lstrip("0").rstrip(self.img_ext))
...
def parse_arguments(argv):
    ...
    parser.add_argument('saved_dir', type=str, help='Directory to save pairs.', default='data/pairs.txt')
